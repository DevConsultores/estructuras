...
M(obi|ini)|Blazer|Dolfin|Dolphin|Skyfire|Zune" "mobile";
}
map $device_category $is_mobile {
        default 0;
        "mobile" 1;
}
...
server {
    ...
    include fastcgi.conf;
        ...
        location ~ ^/revive/(.*) {
          proxy_pass http://149.56.67.70/$1$is_args$args;
          proxy_redirect     off;
...
{{ end }}
        location ~* /system/files/ {
            ...
            fastcgi_param SCRIPT_FILENAME $document_root/index.php;
               fastcgi_param HTTP_X_DEVICE $device_category;
                fastcgi_param HTTP_X_MOBILE $is_mobile;
